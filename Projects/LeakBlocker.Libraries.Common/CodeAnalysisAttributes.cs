...
namespace LeakBlocker.Libraries.Common
{
    ...
    ///             To set the condition, mark one of the parameters with <see cref="ContractAnnotationAttribute"/> attribute
    /// 
    /// </summary>
    /// <seealso cref="ContractAnnotationAttribute"/>
    [AttributeUsage(AttributeTargets.Method, AllowMultiple = false, Inherited = true)]
    ...
    /// </code>
    /// </example>
    [SuppressMessage("Microsoft.Design", "CA1019:DefineAccessorsForAttributeArguments"), AttributeUsage(AttributeTargets.Class, AllowMultiple = true, Inherited = true)]
    ...
    [SuppressMessage("Microsoft.Design", "CA1019:DefineAccessorsForAttributeArguments"), SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly", MessageId = "API")]
    [MeansImplicitUse]
